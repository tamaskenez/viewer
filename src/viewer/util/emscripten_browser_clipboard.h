// Copied from:
// https://github.com/Armchair-Software/emscripten-browser-clipboard/blob/main/emscripten_browser_clipboard.h
// ---- BEGIN ORIGINAL FILE ----
#pragma once
...
#define _EM_JS_INLINE(ret, c_name, js_name, params, code)                                                 \
    ...
    __attribute__((section("em_js"), aligned(1))) inline char __em_js__##js_name[] = #params "<::>" code; \
    }
...
using paste_handler = void (*)(const std::string&, void*);
...
emscripten_browser_clipboard_detail_paste_return(char const* paste_data, paste_handler callback, void* callback_data);
...
EMSCRIPTEN_KEEPALIVE inline char const*
emscripten_browser_clipboard_detail_copy_return(copy_handler callback, void* callback_data);
